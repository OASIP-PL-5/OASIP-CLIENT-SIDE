    ...
    <form v-on:submit.prevent>
      <div class="fixed z-40 inset-0 top-screen bg-black bg-opacity-25 ">
        <div class="flex justify-center items-center h-full w-full  ">
          <div class="md:w-3/12 bg-white rounded shadow-2xl p-8 m-4 ">
            ...
            <div class="flex flex-col mb-4">
              ...
              <input class="border py-2 px-3 text-grey-800 rounded-lg" required v-model.trim="newUser.newName"
                type="string" :placeholder="'Somchai Jairuk (ss-5)'" maxlength="100" />
              <!-- pattern="[A-Za-z0-9]+" -->
            </div>
            ...
            <div class="flex justify-end">
              ...
              <button @click="$emit('addUser',
                newUser.newName, newUser.newEmail, newUser.newRole
