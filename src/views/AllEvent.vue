...
<template>
  <div>
          ...
          <form class="grid sm:grid-col gap-4 my-4 mx-auto w-10/12">
            <div>
              ...
              >
                ...
                <option
                  v-for="(eventCat, index) in eventCategory"
                  :key="index"
                  :value="{
    ...
    <div
      v-show="haveUpcoming && eventCard != 0"
    ...
    <div>
      <div v-show="eventCard != 0 && haveUpcoming != true && havePast != true">
        <h2 class="font-bold text-5xl mx-10 mt-16 text-slate-700">
          ...
          <span class="text-3xl text-blue-400 mb-4"
            >{{ eventCard.length }} events
          </span>
        </h2>
        <div
          class="
        ...
        >
          <div
            ...
            "
            v-for="(event, index) in eventCard"
            :key="index"
          >
            <div class="px-6 py-2 text-left">
              <div>
                <div class="flex justify-start">
                  <div
                    v-if="event.eventStartTime > currentDateTime"
                    class="
                      bg-blue-100
                      font-semibold
                      rounded-lg
                  ...
                  >
                    <span class="inline-block">
                      <svg width="22" height="22" viewBox="0 -2 24 24">
                        <path
                          fill="currentColor"
                          d="M15 22v-2h4V10H5v4H3V6q0-.825.587-1.412Q4.175 4 
                  ...
                  >
                    <span class="inline-block"
                      ><svg width="22" height="22" viewBox="0 -3 24 24">
                        <path
                          fill="currentColor"
                          d="M16.53 11.06L15.47 10l-4.88 
                  ...
                  <div
                    v-if="userEmail == event.bookingEmail"
                    class="
                      rounded-lg
                ...
                <ul class="mb-2">
                  <li v-show="((checkIsLogin == true && userEmail == event.bookingEmail) || userRole == 'lecturer' || userRole == 'admin')">
                  ...
                  <li>
                    ...
                    -
                    {{
                      new Date(new Date(event.eventStartTime).getTime() + event.eventDuration * 60000).toLocaleTimeString("en", {
                        hour: "2-digit",
                        minute: "2-digit",
                      })
                    }}
              ...
              <div class="flex my-2">
                <span class="content-center mx-auto">
                  ...
                  >
                    <button v-show="((checkIsLogin == true && userEmail == event.bookingEmail) || userRole == 'lecturer' || userRole == 'admin')" :class="btnTailWind">
                      Details
                    </button>
                  </router-link>
                </span>
