...
//ปล. ยังไม่ได้ดัก กรณี token พัง ทั้ง oasip & azure
  ...
  if (confirm(confirmDel) == true) {
    if (isMsalLogin === false) {
      ...
      if (res.status === 200) {
        ...
        console.log(
          "error cannot delete userId: [" + id + "] please try again"
        );
    } else if (isMsalLogin === true) {
      const res = await fetch(`${baseUrl}/users/${id}`, {
        method: "DELETE",
...
const editUser = async () => {
  ...
  var checkEmail = users.value.filter(function (user) {
    return (
      user.email == editUserEmailModel.value && user.id !== editUserId.value
    );
  });
                ...
                <div class="px-6 py-4 text-left">
                  ...
                  >
                    <div v-show="isClickEdit" class="mb-4">
                      ...
                      <form class="grid grid-col gap-y-2">
                        <label
                          >Name
                          <span class="text-sm font-thin text-red-400"
                            >| Must be unique*</span
                          ></label
                        >
                        <input
                          ...
                          class="
                            ...
                            shadow-lg
                          "
                          v-model.trim="editUserNameModel"
                          required
                          maxlength="100"
                        />
                        <span v-show="isNameExist" class="text-red-400"
                          >This user name is already used.</span
                        >
                        <label
                          >Email
                          <span class="text-sm font-thin text-red-400"
                        ...
                        <input
                          ...
                          class="
                            ...
                            shadow-lg
                          "
                          v-model.trim="editUserEmailModel"
                          required
                          maxlength="50"
                        />
                        <span v-show="isEmailExist" class="text-red-400"
                  ...
                  type="datetime-local" /> -->
                    ...
                    <div class="flex flex-col justify-center items-center">
                      <div
                        class="text-gray-500 text-xl mb-2 mt-2"
                        v-if="isClickEdit == false"
                      >
                        {{ user.email }}
                      </div>
                      ...
                      <div
                        ...
                        class="text-gray-800 mb-2 sm:text-2xl"
                      >
                        <div>
                          ...
                          <span class="font-bold text-blue-400"
                            ...
                            {{
                              new Date(user.createdOn).toLocaleTimeString(
                                "en",
                                {
                                  hour: "2-digit",
                                  minute: "2-digit",
                        ...
                        <div>
                          ...
                          <span class="font-bold text-blue-400"
                            ...
                            {{
                              new Date(user.updatedOn).toLocaleTimeString(
                                "en",
                                {
                                  hour: "2-digit",
                                  minute: "2-digit",
