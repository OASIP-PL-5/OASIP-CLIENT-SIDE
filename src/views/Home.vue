...
const msal = localStorage.getItem(
...
<template>
  <div>
    ...
    <div class="text-gray-600 body-font" id="eventCateSection">
      <div class="container px-24 py-24 mx-auto">
        <div class="flex flex-wrap -m-4">
          <div
            class="p-4 md:w-1/3"
            v-for="(eventCategories, index) in eventCategoryCard"
            :key="index"
          >
            <div
              class="
    ...
    <footer class="p-4 shadow md:px-6 md:py-8z bg-blue-400">
      <span class="block text-lg text-white sm:text-center"
        >© 2022
        <a href="" class="hover:underline" @click="goToContact"
          >PL5 | ALLFORONE </a
        >. All Rights Reserved.
      </span>
    </footer>
