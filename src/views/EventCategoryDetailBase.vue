...
const getThisEventCatCard = async () => {
  ...
  if (isMsalLogin == false) {
    ...
    editCategoryNameModel.value =
      thisEventCategoryDetail.value.eventCategoryName;
    editDescriptionModel.value =
      thisEventCategoryDetail.value.eventCategoryDescription;
          ...
          <div class="px-6 py-4 text-left">
            <div class="md:flex flex-col justify-center items-center">
              ...
              <div v-show="isClickEdit" class="mb-4">
                ...
                <form class="grid grid-col gap-y-2">
                  ...
                  <input
                    ...
                    v-model.trim="editCategoryNameModel"
                    required
                  />
                  ...
                  />
                  <label
                    >Duration<span class="text-sm font-thin text-red-400">
                      | Between 1 - 480 minutes*</span
                    ></label
                  >
                  <input
                    type="number"
              ...
              <div class="flex flex-col justify-center items-center">
                ...
                <div
                  class="text-gray-500 text-xl mb-3 max-w-xl"
                  v-if="isClickEdit == false"
                >
                  <p
                    v-if="
                      thisEventCategoryDetail.eventCategoryDescription ===
                        null ||
                      thisEventCategoryDetail.eventCategoryDescription == 0
                    "
                  >
                ...
                <div class="grid md:grid-cols-2 w-full">
                  ...
                  <BtnEditEventCategory
                    @editEventCategory="updateEventCategory"
                    v-show="isClickEdit"
                    class="
                      text-orange-400
                      hover:text-white
