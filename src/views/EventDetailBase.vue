          ...
          >
            ...
            >
              <div class="px-6 py-4 text-left">
                ...
                <div
                  v-for="(eventDetail, index) in thisEventDetail"
                  :key="index"
                ...
                >
                  ...
                  <div class="flex flex-col justify-center items-center">
                    <div
                      class="text-gray-500 text-xl mb-4"
                      v-if="isClickEdit == false"
                    >
                      {{ eventDetail.bookingEmail }}
                    </div>
                    <div
                      class="text-gray-200 text-xl mb-4"
                      v-if="isClickEdit == true"
                    >
                      {{ eventDetail.bookingEmail }}
                    </div>
                    ...
                    >
                      ...
                      <span v-show="isClickEdit" class="font-light text-lg"
                        >({{ eventDetail.eventDuration }} minutes)</span
                      >
                    </div>
                    ...
                    <div
                      v-show="isClickEdit == false"
                      class="text-gray-800 text-2xl"
                    >
                      {{
                        new Date(eventDetail.eventStartTime).toLocaleDateString(
                          "en"
                        )
                      }}
                      {{
                        new Date(eventDetail.eventStartTime).toLocaleTimeString(
                          "en",
                          {
                            hour: "2-digit",
                            minute: "2-digit",
                    ...
                    <div
                      v-show="isClickEdit"
                      class="text-gray-800 text-2xl mt-2 mb-3 relative"
                    >
                      <div class="grid">
                        <input
                          class="
                        ...
                        <div v-if="loadFile" class="max-w-sm w-full">
                          <div class="animate-pulse">
                            ...
                            <div class="grid grid-cols-3 gap-4">
                              <div
                                class="h-2 bg-orange-200 rounded col-span-1"
                              ></div>
                            </div>
                            <!-- </div> -->
                            <!-- </div> -->
                    ...
                    <textarea
                      ...
                      class="
                        ...
                        mb-3
                      "
                      placeholder="maximum at 500 characters"
                    />
                    ...
                    <div class="flex flex-col mb-2" v-if="isClickEdit == true">
                      <label class="mb-2 font-bold text-lg text-gray-900"
                        ...
                        <span class="text-sm font-thin">
                          | Optional<span
                            v-if="isTooLarge == true"
                            class="block text-red-400 font-bold"
                          >
                            Please Choose again.</span
                          ></span
                        ></label
                      >
                      <div class="flex item-center justify-between">
                        <input
                          ...
                          @change="fileAction"
                        />
                        <button v-if="hasFile == true" @click="deleteFile">
                          <svg
                            width="32"
                            height="32"
                            viewBox="0 0 24 24"
                          ...
                          >
                            <path
                              fill="currentColor"
                              d="M7 4V2h10v2h5v2h-2v15a1 1 0 0 1-1 1H5a1 
                      ...
                      <p
                        v-if="hasFile == true"
                        class="text-slate-900 mt-1 m-auto"
                      >
                        The old file
                        <span class="font-medium text-blue-500"
                          >({{ thisEventFile.fileName }}) </span
                        >will be replaced/removed.
                      </p>
                    </div>

                    <div
                      class="grid md:grid-cols-4 w-full"
                      v-if="isClickEdit == false"
                    >
                      <button
                        class="
                      ...
                      <button
                        v-if="(isOwner && userRole != 'lecturer') || userRole == 'student'"
                        @click="onClickEdit"
                        class="
                          text-orange-400
                          hover:text-white
                    ...
                    <div v-show="isClickEdit" class="text-2xl">
                      <span class="text-slate-600 text-lg" v-if="editLoading"
                        >Proceeding.</span
                      >
